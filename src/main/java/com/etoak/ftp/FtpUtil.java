...
public class FtpUtil {
     ...
     *             on I/O errors
     */
    public void download(String ftpFileName, File localFile,boolean isDelete) throws IOException {
    ...
    public void mkdirs(String path) {
        if(StringUtils.isNotBlank(path)){
            String[] paths = path.split(file_separator);
            String sep = "";
            for (String s : paths) {
    ...
    public static void main(String[] args) throws IOException {
    	...
    	ftpUtil.connect("192.168.1.110", 21, "zhangcheng", "1", false);
    	//ftpUtil.download("T_CMP_TYPE_BOOKITEM.csv", new File("D:\\data\\0.csv"), false);
    	//ftpUtil.setWorkingDirectory("zhangcheng");
		List<FTPFile> list = ftpUtil.listFiles("zhangcheng");
	}
}