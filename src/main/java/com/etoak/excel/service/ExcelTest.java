	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			for (int i = 0; i < 9; i++) { // 循环9次，每一次都要跨单元格显示
				...
				sheet.addMergedRegion(new CellRangeAddress(0,  (celln + 1), 0, (celle + 1)));
			...
			// 合计 在最后加上，还要跨一个单元格
			sheet.addMergedRegion(new CellRangeAddress(0,  (2 * num + 1), 0, (2 * num + 2)));
			...
			// 百分比 同上
			sheet.addMergedRegion(new CellRangeAddress(0,  (2 * num + 3), 0, (2 * num + 4)));
